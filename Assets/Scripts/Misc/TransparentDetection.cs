...
public class TransparentDetection : MonoBehaviour
{
    ...
    IEnumerator FadeRoutine(SpriteRenderer sp, float fadeTime, float startValue, float targetTransperent)
    {
        float elapsedTime = 0;
        ...
        while (elapsedTime < fadeTime)
        {
            ...
            float newAlpha = Mathf.Lerp(startValue, targetTransperent, elapsedTime / fadeTime);
